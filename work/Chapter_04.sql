...
FROM 'C:\work\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'C:\work\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\work\us_counties_export.txt'
...
TO 'C:\work\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'C:\work\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
